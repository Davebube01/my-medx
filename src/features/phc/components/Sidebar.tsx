import { Building, Building2, ChevronLeft, ChevronRight, LayoutDashboard, Menu, Package, Settings, User, X } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`hidden md:flex lg:inset-y-0 lg:left-0 lg:z-50 lg:flex-col bg-surface border-r border-border healthcare-shadow transition-all duration-300 ${
