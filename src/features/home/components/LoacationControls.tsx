      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center space-x-3">
            <Button
              ...
              className={locationStatus === 'success' ? 'bg-green-500 hover:bg-green-600 text-white' : ''}
            >
              {buttonContent.icon}
              {buttonContent.text}
            </Button>
        ...
        <div className="w-full sm:w-auto sm:min-w-[200px]">
          <div className="space-y-2">
            ...
            <Select value={currentRadius.toString()} onValueChange={handleRadiusChange}>
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm text-gray-600">
            ...
            <ul className="space-y-1">
              <li>• Enable location services for accurate nearby pharmacy results</li>
              <li>• Larger radius shows more pharmacies but may include distant options</li>
              <li>• Your location is only used to find nearby pharmacies and is not stored</li>
            </ul>
          </div>
        </div>
      </div>
