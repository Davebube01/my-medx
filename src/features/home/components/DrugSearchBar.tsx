...
const DrugSearchBar: React.FC<DrugSearchBarProps> = ({ 
  ...
  const drugDatabase: Drug[] = [
    { id: 1, name: "Aspirin", category: "Pain Relief", strength: "325mg", form: "Tablet" },
    { id: 2, name: "Ibuprofen", category: "Pain Relief", strength: "200mg", form: "Tablet" },
    { id: 3, name: "Acetaminophen", category: "Pain Relief", strength: "500mg", form: "Tablet" },
    { id: 4, name: "Insulin", category: "Diabetes", strength: "100 units/mL", form: "Injection" },
    { id: 5, name: "Metformin", category: "Diabetes", strength: "500mg", form: "Tablet" },
    { id: 6, name: "Lisinopril", category: "Blood Pressure", strength: "10mg", form: "Tablet" },
    { id: 7, name: "Amlodipine", category: "Blood Pressure", strength: "5mg", form: "Tablet" },
    { id: 8, name: "Atorvastatin", category: "Cholesterol", strength: "20mg", form: "Tablet" },
    { id: 9, name: "Omeprazole", category: "Acid Reflux", strength: "20mg", form: "Capsule" },
    { id: 10, name: "Albuterol", category: "Asthma", strength: "90mcg", form: "Inhaler" }
  ];
  ...
  return (
    <div ref={searchRef} className="relative w-full max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="flex items-center space-x-3">
        <div className="relative flex-1">
          <Input
            ...
            onFocus={() => {
              if (localSearchValue.trim().length > 0 && suggestions.length > 0) {
                setShowSuggestions(true);
              }
            }}
          />
      ...
      {showSuggestions && (suggestions.length > 0 || localSearchValue.trim().length === 0) && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-80 overflow-y-auto">
          {suggestions.length > 0 ? (
            <div>
              <div className="px-4 py-2 border-b border-gray-200">
                <span className="text-sm font-medium text-gray-600">Drug Suggestions</span>
              </div>
