...
type FilterId = 'open_now' | '24_hours' | 'has_parking' | 'drive_through' | 'delivery' | 'accepts_insurance';
...
const QuickFilters: React.FC<QuickFiltersProps> = ({ 
  ...
  const renderIcon = (iconName: keyof typeof LucideIcons, size: number = 18, className: string = '') => {
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="text-xs text-gray-600">
            ...
            <ul className="space-y-0.5">
              ...
              <li>• "Open Now" shows pharmacies currently accepting customers</li>
